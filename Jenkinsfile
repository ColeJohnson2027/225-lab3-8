pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/ColeJohnson2027/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('john2027-sp26')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
